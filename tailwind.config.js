...
const {
  ...
  ParagraphsText2xlRegular: Text2xl,
  HeadingsDesktopHeadingXsReg: HeadingXs,
  HeadingsDesktopHeadingSmReg: HeadingSm,
  HeadingsDesktopHeadingMdBlack: HeadingMd, // @TODO: Clarification needed
  HeadingsDesktopHeadingLgReg: HeadingLg,
  HeadingsDesktopHeadingXlBlack: HeadingXl,
  HeadingsDesktopHeading2xlReg: Heading2xl,
  HeadingsDesktopHeading3xlBlack: Heading3xl,
} = tokens
  ...
  theme: {
    ...
    fontSize: {
      ...
      '2xl': [
        Text2xl.fontSize,
        {
          lineHeight: Text2xl.lineHeight,
          letterSpacing: Text2xl.letterSpacing,
          fontWeight: Text2xl.fontWeight,
          fontFamily: Text2xl.fontFamily,
          fontStyle: Text2xl.fontStyle,
          fontStretch: Text2xl.fontStretch,
          textTransform: Text2xl.textCase,
        },
      ],
    },
    headingSize: {
